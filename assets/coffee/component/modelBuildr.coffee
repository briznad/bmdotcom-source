    ...
    experience: [
      {
        ...
        achievements : [
          ...
          'Designed, prototyped, and implemented internal curation tools, providing editorial and merchandising teams granular control over content and sale item placement through an intuitive interface.'
